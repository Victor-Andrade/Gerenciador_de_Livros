package com.victorandrade.gerenciadordelivros.adapter;
...
import com.victorandrade.gerenciadordelivros.views.MainActivity;
...
public class LivroAdapter extends RecyclerView.Adapter<LivroAdapter.LivroHolder> {
    ...
    public LivroAdapter(List<Livro> listaLivros, Context context, OnLivroListener onLivroListener) {
